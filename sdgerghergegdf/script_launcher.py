...
class ScriptLauncherManager:
    ...
    def show_settings_window(self):
        ...
        tb.Button(btn_frame, text="Загрузить выбранную", bootstyle="secondary", command=load_selected).pack(side=tk.LEFT, padx=2)
        tb.Button(btn_frame, text="Сохранить кнопку", bootstyle="success", command=save).pack(side=tk.LEFT, padx=2)
        tb.Button(btn_frame, text="Удалить выбранную", bootstyle="danger", command=delete_selected).pack(side=tk.LEFT, padx=2)
